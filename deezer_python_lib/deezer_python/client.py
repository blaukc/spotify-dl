...
from deezer_python.exceptions import DeezerErrorResponse, DeezerHTTPError
...
class Client:
    ...
    def _process_json(self, item, parent=None):
        ...
        to :class:`~deezer_python.resources.Resource` object

        :returns: instance of :class:`~deezer_python.resources.Resource`
        """
        if "data" in item:
    ...
    def get_object(
        ...
        :returns: an :class:`~deezer_python.resources.Resource` or subclass.
        """
    ...
    def get_album(self, object_id, relation=None, **kwargs):
        ...
        :returns: an :class:`~deezer_python.resources.Album` object
        """
    ...
    def get_artist(self, object_id, relation=None, **kwargs):
        ...
        :returns: an :class:`~deezer_python.resources.Artist` object
        """
    ...
    def get_chart(self, relation=None, index=0, limit=10, **kwargs):
        ...
        :returns: a list of :class:`~deezer_python.resources.Resource` objects.
        """
    ...
    def get_comment(self, object_id):
        ...
        :returns: a :class:`~deezer_python.resources.Comment` object
        """
    ...
    def get_episode(self, object_id):
        ...
        :returns: a :class:`~deezer_python.resources.Episode` object
        """
    ...
    def get_genre(self, object_id):
        ...
        :returns: a :class:`~deezer_python.resources.Genre` object
        """
        return self.get_object("genre", object_id)

    def get_genres(self):
        """
        :returns: a list of :class:`~deezer_python.resources.Genre` objects.
        """
    ...
    def get_playlist(self, object_id):
        ...
        :returns: a :class:`~deezer_python.resources.Playlist` object
        """
    ...
    def get_podcast(self, object_id):
        ...
        :returns: a :class:`~deezer_python.resources.Podcast` object
        """
    ...
    def get_radio(self, object_id=None):
        ...
        :returns: a :class:`~deezer_python.resources.Radio` object
        """
    ...
    def get_radios(self):
        ...
        :returns: a list of :class:`~deezer_python.resources.Radio` objects
        """
    ...
    def get_track(self, object_id):
        ...
        :returns: a :class:`~deezer_python.resources.Track` object
        """
    ...
    def get_user(self, object_id):
        ...
        :returns: a :class:`~deezer_python.resources.User` object
        """
    ...
    def get_user_albums(self, user_id: Optional[int] = None) -> List[Album]:
        ...
        :return: a list of :class:`~deezer_python.resources.Album` instances.
        """
    ...
    def get_user_artists(self, user_id: Optional[int] = None) -> List[Artist]:
        ...
        :return: a list of :class:`~deezer_python.resources.Artist` instances.
        """
        user_id_str = str(user_id) if user_id else "me"
    ...
    def get_user_tracks(self, user_id: Optional[int] = None) -> List[Track]:
        ...
        :return: a list of :class:`~deezer_python.resources.Track` instances.
        """
        user_id_str = str(user_id) if user_id else "me"
