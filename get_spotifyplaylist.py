...
def get_spotify_playlist(playlist_url, token):
    ...
    url = 'https://api.spotify.com/v1/playlists/' + playlist_id + '/tracks?fields=items.track(name%2Cartists.name%2Calbum.name)'    #adds fields to narrow spotify web api search
